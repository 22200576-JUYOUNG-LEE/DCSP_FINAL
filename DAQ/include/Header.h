...
#define   LIN_GYRO_START        (double)(     90.6066)
#define   LIN_V_DEADZONE        (double) (    0.05)
#define   LIN_COEFFI_POSITIVE_A (double)(-313.5497)
#define   LIN_COEFFI_POSITIVE_B (double)(3016.6342)
#define   LIN_COEFFI_POSITIVE_C (double)(-5849.5654)
#define   LIN_COEFFI_NEGATIVE_A (double)(373.0041)
#define   LIN_COEFFI_NEGATIVE_B (double)(-329.4004)
#define   LIN_COEFFI_NEGATIVE_C (double)(-1203.8487)
